...
namespace YouTube_downloader
{
	public class MultipleProgressBar : Control
	{
		...
		private readonly Color _defaultBackgroundColor = Color.Lime;
		...
		{
			SetItem(min, max, value, title, _defaultBackgroundColor);
		}
		...
		{
			SetItem(percentValue, _defaultBackgroundColor);
		}
